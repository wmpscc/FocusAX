...
from paperparse.rectangle_box_opt import inter_rec, neighbor_rec
import numpy as np
import configs
...
def init_model():
    model = lp.PaddleDetectionLayoutModel(
        config_path=None,
        model_path='paperparse/ppyolov2_r50vd_dcn_365e_publaynet',
        threshold=configs.threshold,
        enable_mkldnn=configs.enable_mkldnn,
        enforce_cpu=configs.enforce_cpu,
